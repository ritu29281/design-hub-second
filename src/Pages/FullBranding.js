...
const FullBranding = () => {
  ...
  useEffect(() => {
    setInputValue(` price change $${sliderValue[0]} - $${sliderValue[1]}`);
  }, [sliderValue]);
  ...
  return (
    <main className="maincomponent">
      ...
      <div className="form" style={{ width: "505px" }}>
