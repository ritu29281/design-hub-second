      ...
      <div className="form">
        <form className="row g-3">
          ...
          {/* <div className="col-12">
            ...
            <select id="inputState" className="form-select">
              <option selected>Your Project name</option>
              <option>..</option>
            </select>
          </div> */}
          ...
          <div className="col-12">
            ...
            <select id="inputState" className="form-select">
              ...
              <option>Game Interfaces</option>
              <option>Wireframing</option>
              <option>Prototyping</option>
              <option>User Flows</option>
              <option>Transition Designs</option>
              <option>Navigation Design</option>
              <option>Icons and Symbols</option>
            </select>
          </div>
          <div className="col-12">
